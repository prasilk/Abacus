...
if ($imagelink!="") {
	echo "<div id='postimagebox'><img src='uploaded_images/".$imagelink."' id='postimage'></div>";
}
...
echo "<div id='iconp'><a href='viewuser.php?usn=".$usn."' target='_blank'><img src='profilepics/thumb/".$imagelink."' id='profilepic'></a><br>".$name."</div>";
echo "<div id='viewview'>";
echo "<b>Name : </b>".$name;
