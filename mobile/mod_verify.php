...
<a href="mod.php" id="omnilink">Moderator Panel</a> &gt; Verify Process </div> <br><h3>Log:</h3>
<?php
$usn=$_POST['usn'];
$pass=$_POST['pass'];
$flag=0;
...
if ($pass=="mod3344") {
	...
	echo "<br><br><a href='mod.php'>Verify another user</a> | <a href='index.php'>Exit Moderator Panel</a>";
	$flag=1;
}

if ($flag==0) {
	echo "Moderator password entered is incorrect.";
	echo "<br><br><a href='mod.php'>Try Again</a> | <a href='index.php'>Exit Moderator Panel</a>";
}
