...
echo "<text id='countbox'>".$count."</text><text id='datebox'>".$row['dateposted']."</text> <a href='viewpost.php?postid=".$row['item_id']."&&cate=Computer' id='buylist'>".$row['itemname']."</a> by ".$row['postedby_name']." for <b>Rs. ".$row['price']."</b> [ ".$row['category'];
if ($row['sold']=='y') {
