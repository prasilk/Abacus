...
?>
<head>
<title>Abacus&#8482 Sold Process</title>
...
$wrongpass=0;
echo "<br><br><a href='marksold.php?postid=".$postid."&&cate=".$cate."&&usn=".$usn."' id='pagebutton'>Alrighty, I'll try again</a><a href='index.php' id='pagebutton'>Goto home</a>";
...
if ($password==$passavailable) {
$query3="UPDATE `abacus`.`items` SET `sold` = 'y' WHERE `items`.`item_id` =".$postid.";";
$res3=mysql_query($query3);
echo "<br><h3>Post marked sold!</h3>";
$wrongpass=0;
?><br>
...
<br><br>
<?php
echo "<a href='marksold.php?postid=".$postid."&&cate=".$cate."&&usn=".$usn."' id='pagebutton'>Alrighty, I'll try again</a><a href='index.php' id='pagebutton'>Goto home</a>";
}//end if
